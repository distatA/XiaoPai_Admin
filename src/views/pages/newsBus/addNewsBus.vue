    ...
    <el-main>
        <el-form class="form" ref="form" :model="form" size="small" label-width="100px">
            ...
            <el-form-item label="教育新闻标题:">
                <el-input v-model="form.zbc_title" placeholder="请输入新闻标题(限32个字以内)"></el-input>
            </el-form-item>
...
export default {
    ...
    created() {
        ...
        // this.$post("/admin/article/getone", { id: this.form.id }).then(res => {
        //     this.form = res.info;
        // });
    },
    methods: {
        add() {
            ...
            this.$post("/admin/article/add_zbc", this.form).then(res => {
                if (res.code === 1) {
                    this.$message({
                        showClose: true,
                        message: res.msg,
