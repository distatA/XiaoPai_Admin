...
<template>
    <el-main>
        <div class="flex">
            <div>
                <el-button type="primary" size="mini" @click="handleJump('true','')">添加学校真题</el-button>
                <el-button
                    type="danger"
                    size="mini"
            ...
            <div>
                ...
                <el-button type="primary" size="mini" @click="loadQuestionList(1,province)">搜索</el-button>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getCurrentage(pages) {
            this.loadQuestionList(pages, this.province);
        },
        //加载分类招生学校真题列表
        loadQuestionList(pages, province) {
            this.page = pages;
            this.$post("/admin/classifie/index_question_school", {
                page: this.page,
                num: this.offset,
        ...
        changeSort(item, value, dateSort) {
            this.$post("/admin/classifie/ajaxsort_question_school", {
                id: item.id,
                dataSort: dateSort,
                sort: value
            }).then(res => {});
        ...
        handleDelete(item) {
            ...
            this.$confirm("此操作将永久删除真题, 是否继续?", "提示", {
                ...
                .then(() => {
                    this.$post("/admin/classifie/delete_question_school", {
