<template>
    <el-main>
        <div class="flex">
            <div>
                <el-button type="primary" size="mini" @click="add">添加学科</el-button>
                <el-button
                    type="danger"
                    size="mini"
        ...
        <el-dialog title="提示" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
            <el-form :model="form" ref="form" size="mini" label-width="100px">
                <el-form-item label="学科名称:" prop="year">
...
export default {
    ...
    methods: {
        ...
        loadAreaList(pages, name) {
            this.page = pages;
            this.$post("/admin/entrance/index_subject", {
                page: this.page,
                num: this.offset,
        ...
        handleAdd() {
            ...
            this.$post("/admin/entrance/add_subject", this.form).then(res => {
                if (res.code === 1) {
                    this.$message({
                        message: res.msg,
                        type: "success"
        ...
        edit(item) {
            this.$post("/admin/entrance/getone_subject", {
                id: item.id
            }).then(res => {
                this.form = res.info;
                this.dialogVisible = true;
        ...
        handleEdit() {
            this.$post("/admin/entrance/edit_subject", this.form).then(res => {
                if (res.code === 1) {
                    this.$message({
                        message: res.msg,
                        type: "success"
        ...
        handleDelete(item) {
            ...
            this.$confirm("此操作将永久删除数据, 是否继续?", "提示", {
                ...
                .then(() => {
                    this.$post("/admin/entrance/delete_subject", {
