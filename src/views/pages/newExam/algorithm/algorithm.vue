<template>
    <el-main>
        <div class="flex">
            <div>
                <el-button type="primary" size="mini" @click="add">添加算法</el-button>
                <el-button
                    type="danger"
                    size="mini"
        ...
        <el-table border :data="algorithmList" @selection-change="handleSelect">
            ...
            <el-table-column prop="choose_num" label="选择" align="center"></el-table-column>
        ...
        <el-dialog title="提示" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
            <el-form :model="form" ref="form" size="mini" label-width="100px">
                <el-form-item label="学科:" prop="year">
                    <el-select v-model="form.choose" multiple placeholder="请选择学科">
                        <el-option
                ...
                <el-form-item label="选择数量:">
                    <el-input v-model="form.choose_num" placeholder="请输入选择数量"></el-input>
                </el-form-item>
                <el-form-item label="排序:">
                    <el-input v-model="form.sort" placeholder="请输入排序"></el-input>
                </el-form-item>
                <el-form-item label="显示文字:">
                    <el-input v-model="form.wenzi" placeholder="请输入显示文字"></el-input>
                </el-form-item>
                <el-form-item>
...
export default {
    ...
    methods: {
        ...
        loadAreaList(pages, name) {
            this.page = pages;
            this.$post("/admin/entrance/index_algorithm", {
                page: this.page,
                num: this.offset,
        ...
        handleAdd() {
            ...
            this.$post("/admin/entrance/add_algorithm", this.form).then(res => {
                if (res.code === 1) {
                    this.$message({
                        message: res.msg,
                        type: "success"
        ...
        edit(item) {
            this.$post("/admin/entrance/getone_algorithm", {
                id: item.id
            }).then(res => {
                var choose = [];
                res.info.choose.forEach(item => {
                    choose.push(parseInt(item));
                });
                this.form = res.info;
                this.form.choose = choose;
        ...
        handleEdit() {
            this.$post("/admin/entrance/edit_algorithm", this.form).then(
                res => {
                    if (res.code === 1) {
                        this.$message({
                            message: res.msg,
        ...
        handleDelete(item) {
            ...
            this.$confirm("此操作将永久删除数据, 是否继续?", "提示", {
                ...
                .then(() => {
                    this.$post("/admin/entrance/delete_algorithm", {
