<template>
    <el-main>
        <div class="flex">
            <div>
                <el-button type="primary" size="mini" @click="handleJump('add','')">添加学院</el-button>
                <el-button
                    type="danger"
                    size="mini"
            ...
            <div>
                ...
                <el-button
                    ...
                    type="primary"
                    size="mini"
                    @click="loadCollegeList(1,keyword)"
                >搜索</el-button>
            </div>
        </div>

        <el-table border :data="collegeList" @selection-change="handleSelect">
            <el-table-column type="selection" width="55"></el-table-column>
            <el-table-column prop="title" label="学院名称" align="center"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getCurrentage(pages) {
            this.loadCollegeList(pages, this.keyword);
        },
        //加载政策列表
        loadCollegeList(pages, keyword) {
            this.page = pages;
            this.$post("/admin/optimal/college", {
                page: this.page,
                num: this.offset,
        ...
        handleDelete(item) {
            ...
            this.$confirm("此操作将永久删除学院, 是否继续?", "提示", {
                ...
                .then(() => {
                    this.$post("/admin/optimal/college_del", {
