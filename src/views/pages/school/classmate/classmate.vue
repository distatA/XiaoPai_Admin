<template>
    <el-main>
        <el-row class="add">
            <el-col :span="3">
                <el-button
                    @click="handleJump('modifyClassmate-modifyClassmate',true,'')"
                    type="primary"
                    size="mini"
                >添加知名校友</el-button>
            </el-col>
        ...
        <el-table border :data="classmateList" @selection-change="handleSelect">
            <el-table-column type="selection" width="55" align="center"></el-table-column>
            <el-table-column prop="school_name" label="学校名称" align="center"></el-table-column>
            <el-table-column prop="name" label="校友名称" align="center"></el-table-column>
            <el-table-column label="操作" width="400" align="center">
                <template slot-scope="scope">
                    <el-button
                        @click="handleJump('modifyClassmate-modifyClassmate',false,scope.row)"
                        type="primary"
                        size="mini"
                    >编辑</el-button>
...
export default {
    ...
    methods: {
        ...
        loadMajorList(pages) {
            this.page = pages;
            this.$post("/admin/school/index_alumni", {
                page: this.page,
                num: this.offset,
        ...
        handleDelete(item) {
            ...
            this.$confirm("此操作将永久删除该知名校友, 是否继续?", "提示", {
                confirmButtonText: "确定",
                cancelButtonText: "取消",
                type: "warning"
            })
                .then(() => {
                    this.$post("/admin/school/delete_alumni", {
