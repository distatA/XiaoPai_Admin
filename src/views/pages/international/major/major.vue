    ...
    <el-main>
        <div class="flex">
            <div>
                <el-button
                    type="primary"
                    size="mini"
                    @click="handleJump('','international-modifyMajor','true')"
                >添加专业</el-button>
                <el-button
                    type="danger"
                    size="mini"
        ...
        <el-table border :data="majorList" @selection-change="handleSelect">
            ...
            <el-table-column label="操作" width="200" align="center">
                <template slot-scope="scope">
                    <el-button
                        @click="handleJump(scope.row,'international-modifyMajor','false')"
                        type="primary"
                        size="mini"
                    >编辑</el-button>
    ...
    methods: {
        ...
        handleDelete(item) {
            ...
            this.$confirm("此操作将永久删除学校, 是否继续?", "提示", {
                ...
                .then(() => {
                    this.$post("/admin/abroad/major_del", {
