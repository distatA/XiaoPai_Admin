    ...
    <el-main>
        <el-form :model="form" ref="form" size="mini" :rules="formrules" label-width="100px">
            ...
            <el-form-item label="内容:" prop="content">
                <el-input type="textarea" :rows="9" v-model="form.content" placeholder="请输入内容"></el-input>
            </el-form-item>
            <el-form-item>
...
export default {
    ...
    methods: {
        //
        loadDetail() {
            this.$post("/admin/abroad/environment_getOne", {
                id: this.form.id
            }).then(res => {
                if (res.code === 1) {
                    this.form = res.info;
        ...
        handleAdd() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    ...
                    this.$post("/admin/abroad/environment_add", this.form).then(
                        res => {
                            if (res.code === 1) {
                                this.handleClose();
                            }
