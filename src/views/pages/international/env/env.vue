<template>
    <el-main>
        <div class="flex">
            <div>
                <el-button
                    type="primary"
                    size="mini"
                    @click="handleJump('','international-modifyEnv','true')"
                >添加教学环境</el-button>
                <el-button
                    type="danger"
                    size="mini"
        ...
        <el-table border :data="envList" @selection-change="handleSelect">
            ...
            <el-table-column label="操作" width="200" align="center">
                <template slot-scope="scope">
                    <el-button
                        @click="handleJump(scope.row,'international-modifyEnv','false')"
                        type="primary"
                        size="mini"
                    >编辑</el-button>
...
export default {
    ...
    methods: {
        ...
        getCurrentage(pages) {
            this.loadEnvList(pages);
        },
        //加载分类招生真题列表
        loadEnvList(pages, province) {
            this.page = pages;
            this.$post("/admin/abroad/environment", {
