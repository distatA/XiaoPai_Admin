    ...
    <el-main>
        <div class="add">
            <div>
                <el-button
                    type="primary"
                    size="mini"
                    @click="handleJump('modifyCareerJob-modifyCareerJob',true,'')"
                >添加职业库</el-button>
                <el-button
        ...
        >
            ...
            <el-table-column label="操作" width="400" align="center">
                <template slot-scope="scope">
                    <el-button
                        @click="handleJump('modifyCareerJob-modifyCareerJob',false,scope.row)"
                        type="primary"
                        size="mini"
                    >编辑</el-button>
...
export default {
    ...
    methods: {
        search() {
            this.$post("/admin/job/index_three", {
