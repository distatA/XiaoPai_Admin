<template>
    <el-main>
        <div class="add">
            <div>
                <el-button type="primary" size="mini" @click="handleJump('','true')">添加章节</el-button>
                <el-button
        ...
        <el-table border :data="chapterList" @selection-change="handleSelect">
...
export default {
    ...
    methods: {
        getCurrentPage(pages) {
            this.loadChapterList(pages);
        },
        //加载学校列表
        loadChapterList(pages) {
            this.page = pages;
            this.$post("/admin/course/catalogue", {
                page: this.page,
                num: this.offset,
